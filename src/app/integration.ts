...
declare type IntegrationOptions = { app: roonOptions; controller: nuimoOptions }
...
class Integration {
    ...
    static all(): Integration[] {
        return [
            ...
            (c: IntegrationOptions) => new Integration(c, new Broker(new BrokerConfig("mqtt://mqbroker.home.local:1883")))
        )
    }
}
